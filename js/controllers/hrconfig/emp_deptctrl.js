app.controller('empdept_ctrl', ['$scope', '$timeout','$http', 'editableOptions', 'editableThemes', 
  ...
  $scope.rowCollection = [];
    $http.get('http://localhost/smartedu/HrConfigCtrl/employeeDepartment').success(function(incomingData) {
  ...
  $scope.removeDepartment = function(index) {
    ...
    $http({
      method : "DELETE",
      url : "http://localhost/smartedu/HrConfigCtrl/employeeDepartment",
      params : {id : id},
