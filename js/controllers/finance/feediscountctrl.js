app.controller('feediscountctrl', ['$scope','$rootScope','$localStorage','$location','$timeout','$http','$modal','toaster','$ngBootbox',
  ...
  //----------------------------//
    ...
    $http.get($rootScope.endUrl+'ManageClassModule/ClassDetail',{headers: {'access_token':$scope.access_token}}).success(function(incomingData) {
        ...
        //$scope.isLoading = true;
        $scope.NoData = true;
        var message="No Data Found in fees discount Details"
        console.log($scope.NoData,'check nodata');
