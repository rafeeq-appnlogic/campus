app.controller('feediscountctrl', ['$scope', '$timeout','$http', 'toaster','$rootScope','$localStorage','$location','$ngBootbox','$mdDialog',
...
$scope.access_token=$localStorage.access_token;
 ...
 $scope.showAdvanced = function(ev,mode,data) {
    ...
    $mdDialog.show({
      ...
      templateUrl: 'tpl/Finance/feediscountModal.html',
