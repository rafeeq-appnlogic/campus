app.controller('feeparticularctrl', ['$scope','$rootScope','$localStorage','$location','$timeout','$http','$modal','toaster','$ngBootbox',
...
$scope.options = [
  ...
  $scope.admissionNo = function(){
    $scope.admNo=true;
    $scope.stdCategory=false;
  }
  $scope.studCategory = function(){
    $scope.stdCategory=true;
    $scope.admNo=false;
  }
