app.controller('manageClassCtrl', ['$scope','$rootScope','$localStorage','$location','$timeout','$http','$modal','editableOptions', 'editableThemes','toaster','$ngBootbox','$mdDialog',
  ...
  $scope.showAdvanced = function(ev,mode,data) {
    ...
    $mdDialog.show({
     controller: DialogController,
      templateUrl: 'tpl/academics/classmodal.html',
